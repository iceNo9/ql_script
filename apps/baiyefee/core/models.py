...
class Account(Base):
    ...
    __tablename__ = "baiyefee_accounts"
...
class CheckinLog(Base):
    ...
    __tablename__ = "baiyefee_checkin_logs"
    ...
    account_id: Mapped[int] = mapped_column(
        BigInteger,
        ForeignKey("baiyefee_accounts.id"),
        nullable=False,
        index=True,
    )
    ...
    checkin_points: Mapped[int] = mapped_column(
        Integer,
        default=0,
        nullable=False,
    )
    ...
    def __repr__(self) -> str:
        return (
            ...
            f"checkin_points={self.checkin_points}"
            f")>"
        )
