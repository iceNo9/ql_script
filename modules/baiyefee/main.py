...
def main():
    ...
    # 2. 加载 baiyefee 配置
    baiyefee_config_manager = ConfigManager("./config/baiyefee.yaml")
    baiyefee_config = baiyefee_config_manager.read()
    ...
    # 获取账号列表
    accounts = [{"username": acc.username, "password": acc.password} for acc in baiyefee_config.accounts]
